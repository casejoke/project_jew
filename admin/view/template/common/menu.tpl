<ul class="main-menu">
  ...
  <li><a href="<?php echo $customer_estimate; ?>"><i class="md md-format-list-bulleted"></i> <?php echo $text_customer_estimate; ?> </a></li>
   <li><a href="<?php echo $contest_request; ?>"><i class="md md-format-list-bulleted"></i> <?php echo $text_all_contest_request; ?> </a></li>
  ...
  <li class="sub-menu">
    <a href=""><i class="md md-people-outline"></i> <?php echo $text_customer; ?></a>
    <ul>
  ...
  <li class="sub-menu">
    <a href=""><i class="md md-people"></i> <?php echo $text_users; ?></a>
    <ul>
