                    	...
                    	<div class="col-sm-12">
                          ...
                          <tbody>                    			
                                ...
                                <?php } ?>
  											      ...
  											      <td>
                                <button type="button" onclick="$('#expert-row<?php echo $expert_row; ?>, .tooltip').remove();" data-toggle="tooltip" title="<?php echo $button_remove; ?>" class="btn btn-danger"><i class="fa fa-minus-circle"></i></button>
  											      </td>
		                        </tr>
          									<?php $expert_row++; ?>
          									<?php } ?>
                            ...
                            <tr>
                              <td colspan="2" class="text-center">
                              	<div class="col-sm-offset-4 col-sm-4"><button type="button" onclick="addExpert();" class="btn btn-primary btn-block"><i class="fa fa-plus-circle"> </i>  <?php echo $button_add; ?></button></div>
                              </td>
                            </tr>
                          </tfoot>
	                    	</table>
                        ...
                        <table id="downloads" class="table table-striped">
                          ...
                          <tbody>
                            ...
                            <?php if(!empty($contest_downloads)) { ?> 
                              <?php foreach ($contest_downloads as $cd) { ?>
                                  ...
                                  <td>
                                    ...
                                    <div class="form-group">
                                      <div class="fg-line">
                                            ...
                                            <input type="text" name="contest_downloads[<?php echo $download_row; ?>][download_title]" value="<?php echo $cd['name']; ?>"  id="input-keyword" class="form-control" disabled/>
                                            <input type="hidden" name="contest_downloads[<?php echo $download_row; ?>][download_id]" value="<?php echo $cd['download_id']; ?>"  id="input-keyword" class="form-control" />
...
function addFiles() {
  ...
  html += '<td>';
  html += '<input type="text" name="contest_downloads[' + download_row + '][name]" value="" class="form-control" />';
  html += '</td>';

  /* html += '<td>'
    html += '<div class="form-group"><div class="fg-line"><div class="select">';
    html += '<select name="contest_downloads[' + download_row + '][download_id]" id="input-download_id-' + download_row + '" class="form-control">';
    html += '<option value="0"><?php echo $text_none; ?></option>';
    <?php if (!empty($downloads)) { ?>
      <?php foreach ($downloads as $download) { ?>
    html += '<option value="<?php echo $download['download_id']; ?>"><?php echo $download['download_name']; ?></option>';
      <?php } ?>
    <?php } ?>
    html += '</select></div></div></div></td>';
*/
  ...
  html += '<td>';
  html += '<input type="hidden" name="contest_downloads[' + download_row + '][download_id]" value="" class="form-control" />';
  html += '</td>';
  ...
  function downloadautocomplete(download_row) {
    $('input[name=\'contest_downloads[' + download_row + '][name]\']').autocomplete({
    ...
    'select': function(item) {
       $('input[name=\'contest_downloads[' + download_row + '][name]\']').val(item['label']);
          $('input[name=\'contest_downloads[' + download_row + '][download_id]\']').val(item['value']);
      }
    });
};
//--></script>
