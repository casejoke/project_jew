...
class ModelSaleCustomer extends Model {
	public function addCustomer($data) {
		$this->db->query("INSERT INTO " . DB_PREFIX . "customer SET 
			...
			customer_expert = '" . (int)$data['customer_expert'] . "', 
	...
	public function editCustomer($customer_id, $data) {
		...
		$this->db->query("UPDATE " . DB_PREFIX . "customer SET 
			...
			approved = '" . (int)$data['approved'] . "', 
			safe = '" . (int)$data['safe'] . "' WHERE customer_id = '" . (int)$customer_id . "'");
	...
	public function getCustomers($data = array()) {
		...
		if (!empty($data['filter_customer_expert'])) {
			$implode[] = "c.customer_expert = '" . (int)$data['filter_customer_expert'] . "'";
		}
	...
	public function editStats($customer_id,$data){
		if (isset($data['stats'])) {
			
			$this->db->query("DELETE FROM " . DB_PREFIX . "customer_stats WHERE customer_id = '" . (int)$customer_id . "'");
			
			foreach ($data['stats'] as $stat) {

				$this->db->query("INSERT INTO " . DB_PREFIX . "customer_stats SET 
					customer_id = '" . (int)$customer_id . "', 
					occasion_id = '" . (int)$stat['occasion_id'] . "', 
	...
	///подтяне методы дл статы
	public function getStats($occasion_id) {
		$stats_data = array();
		$stats_data = $this->db->query("SELECT * FROM " . DB_PREFIX . "customer_stats WHERE occasion_id = '" . (int)$occasion_id . "' ORDER BY occasion_date ASC");
		return $stats_data->rows;
	}
