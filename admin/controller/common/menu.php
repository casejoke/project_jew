...
class ControllerCommonMenu extends Controller {
	public function index() {
		...
		$data['text_customer_stats'] 			= $this->language->get('text_customer_stats');
		$data['text_occasion_group'] 	= $this->language->get('text_occasion_group');
		...
		$data['season'] = $this->url->link('catalog/season', 'token=' . $this->session->data['token'], 'SSL');
		...
		$data['contest'] = $this->url->link('contest/contest', 'token=' . $this->session->data['token'], 'SSL');
		$data['occasion'] = $this->url->link('catalog/occasion', 'token=' . $this->session->data['token'], 'SSL');
		$data['occasion_group'] = $this->url->link('catalog/occasion_group', 'token=' . $this->session->data['token'], 'SSL');
