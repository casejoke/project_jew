...
class ControllerModuleAnons extends Controller {
	...
	public function index() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			$this->model_setting_setting->editSetting('anons', $this->request->post);
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('module/anons', 'token=' . $this->session->data['token'], 'SSL')
		);

		$data['action'] = $this->url->link('module/anons', 'token=' . $this->session->data['token'], 'SSL');
